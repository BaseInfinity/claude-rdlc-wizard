...
| `confidence-required.sh` | Before Write/Edit on `research/`, `evidence/` | Requires confidence label on new claims (keep clinical notes under `research/` or `evidence/` — the hook only watches those segments) |
